...
export class TodoService {
     ...
     * @param note
     */
    createTodo(note: string): Observable<UserTodo> {
        return this._httpClient.post<UserTodo>(`${this._baseUrl}/api/UserTodos`, { note }).pipe(
            tap((newTodo) => {
     ...
     * @param todo
     */
    updateTodo(todo: { id: number; note: string; isCompleted: boolean }): Observable<any> {
